      ...
      navigationOptions: {
        drawerIcon: () => (
          <Image
            ...
            source={require('../../assets/dubaiflag.gif')}
          />
        ),
    ...
    Turkey_Pro: {
      ...
      navigationOptions: {
        drawerIcon: () => (
          <Image
            style={{ height: 40, width: 40, resizeMode: 'contain' }}
            source={require('../../assets/turkeyflags.gif')}
          />
        ),
    ...
    Pakistan_Pro: {
      ...
      navigationOptions: {
        drawerIcon: () => (
          <Image
            style={{ height: 40, width: 40, resizeMode: 'contain' }}
            source={require('../../assets/pakistaniflag.gif')}
          />
        ),
            ...
            >
              <View style={styles.drawerLogo}>
                <Image
                  ...
                  source={require('../../assets/realestatelogo.png')}
                />
              </View>
            </View>
