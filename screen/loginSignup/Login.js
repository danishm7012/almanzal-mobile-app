...
{/* <Image source = {require("./assets/logo.png")}/> */}
 ...
 <Text style={{fontFamily:'open-sans-bold',color:'#121212', fontSize:24, textAlign:'center'}}>LogIn</Text>
     </View>   
   
<View style={{flex:0.8,alignSelf:'stretch',justifyContent:'center', alignItems:'center', backgroundColor:'#121212'}}>
